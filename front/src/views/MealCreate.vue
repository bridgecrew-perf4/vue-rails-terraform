    ...
    <v-layout row wrap justify-center>
      ...
      <v-flex xs5 mt-5>
        <v-card>
          <v-card-text>
            <v-form>
              <v-text-field v-model="meal.meal_menu_id" label=""></v-text-field>
              <v-text-field v-model="meal.quantity" label="数量"></v-text-field>
              <v-text-field
...
export default {
  ...
  methods: {
    create() {
      ...
      this.axios.post(`http://localhost:3000/meals`, params);
      alert("食事情報を更新しました");
